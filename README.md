...
I am a **Frontend-Focused Full-Stack Developer** passionate about crafting responsive, user-centric interfaces and connecting them with reliable, high-performance backends.

---

### 🚀 What I Do
- 🎨 Building intuitive, responsive, and accessible user interfaces.
- ⚡ Connecting modern frontends with robust **Node.js & Express** backends.
- 🗄️ Designing structured databases using **MongoDB & Mongoose**.
- 🛠️ Creating seamless end-to-end user flows, state management, and API integrations.
